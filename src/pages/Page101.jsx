...
const Page101 = () => {
    ...
    const rows = [
        { no: 3, product: "BP-201", product_ID: "23459090", CO2EQ: "15.58", last_update: "2022.12.31", super: "DONE", sub: "DONE" },
        { no: 2, product: "BP-701", product_ID: "23458872", CO2EQ: "2.71", last_update: "2022.03.05", super: "DONE", sub: "DONE" },
        { no: 1, product: "BP-772", product_ID: "23459081", CO2EQ: "5.12", last_update: "2022.07.31", super: "DONE", sub: "DONE" },
    ];
