...
import InterX from "../content/images/logo-interx_battery_lab.svg";
import Tesla from "../content/images/logo-tesla.svg";
...
const Page400 = () => {
    ...
    return (
        <>
            <div className="card h-[3.75rem] px-5 flex items-center cursor-pointer select-none" onClick={() => navigate('/Page202')}>
            ...
            <div className="p-[1.875rem]">
                <div className="flex items-center mb-5">
                    ...
                    <div className="w-[18.75rem] px-10 flex items-center justify-center">
                        ...
                        <i className="icon-arrow_move_left text-[4.375rem] w-[4.375rem] h-[4.375rem] inline-block text-primary rotate-180"></i>
                    </div>
                    <div className="card h-[15.5rem] w-[calc(50%_-_9.375rem)] px-[1.875rem] py-7 flex justify-between">
                        <div>
                            <div className="mb-2 pb-[0.625rem]">
                        ...
                        <div className="w-60 h-full pl-[1.875rem] flex items-center justify-center border-l border-border-light">
                            <img src={AlphaEnsol} alt="alpha ensol" className="w-[9.375rem]"/>
                        </div>
                    </div>
                </div>
